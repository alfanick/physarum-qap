...
% TODO crawl phase
% TODO choosen the best candidate from frontier
% TODO adds the best candidate to the body if has enough food eatign e_crawl
% TODO removes its body from every FS which is worse from the worst in frontier (even if moved there) 
