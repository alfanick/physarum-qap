...
\begin{figure}
  ...
  \includegraphics[width=1.1\textwidth,center]{algorithm/metaheuristic/charts/tai/frontier_best_cost aggregated min - tai150b $l=100$ $k=300000$.\eop}
...
\begin{table}
  \centering
  \caption{Comparison of distance to optimal solution using different methods \textbf{formatting!}}
