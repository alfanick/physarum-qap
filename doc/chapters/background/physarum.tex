...
A common problem testing autonomous navigational skills in robotics is U-shaped trap problem. Efficient solution of the issue requires some kind spatial memory or other navigational aids, therefore it was a good candidate for a test of slime mould's memoizing capabilities. 
% TODO introduce u-maze, robotics
